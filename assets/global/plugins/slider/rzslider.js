...
(function(root, factory) {
  ...
  .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
    ...
    var Slider = function(scope, sliderElem) {
       ...
       */
      this.range = this.scope.rzSliderModel !== undefined && this.scope.rzSliderHigh !== undefined && this.scope.rzVidApi==undefined;
      ...
      callOnStart: function() {
        if (this.options.onStart) {
          ...
          this.scope.$evalAsync(function() {
            self.options.onStart(self.scope.rzVidApi, self.scope.rzSliderModel, self.scope.rzSliderHigh, pointerType);
          });
        }
      },
      ...
      callOnChange: function() {
        if (this.options.onChange) {
          var self = this,
            pointerType = this.tracking === 'lowValue' ? 'min' : 'max';
          this.scope.$evalAsync(function() {
            self.options.onChange(self.scope.rzVidApi, self.scope.rzSliderModel, self.scope.rzSliderHigh, pointerType);
          });
        }
      },
      ...
      callOnEnd: function() {
        if (this.options.onEnd) {
          var self = this,
            pointerType = this.tracking === 'lowValue' ? 'min' : 'max';
          this.scope.$evalAsync(function() {
            self.options.onEnd(self.scope.rzVidApi, self.scope.rzSliderModel, self.scope.rzSliderHigh, pointerType);
          });
        }
