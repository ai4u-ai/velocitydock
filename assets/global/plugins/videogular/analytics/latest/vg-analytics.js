...
angular.module("com.2fdevs.videogular.plugins.analytics", ["angulartics"])
    .directive(
    "vgAnalytics",
    ["$analytics", "VG_STATES","videoService", function ($analytics, VG_STATES,videoService) {
        return {
            restrict: "E",
            require: "^videogular",
            scope: {
            ...
            link: function (scope, elem, attr, API) {
                ...
                var progressTracks = [];
                if(angular.isUndefined(scope.vgTrackInfo)){
                  scope.vgTrackInfo=videoService.analytics;
                };
                scope.API = API;
