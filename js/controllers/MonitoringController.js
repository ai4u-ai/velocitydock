...
*/
MetronicApp.controller('MonitoringController',function ($scope, API_ENDPOINT,AuthService,$http,$location, rx,$location, $anchorScroll,videoService) {
    ...
    */
    ...
    $scope.onPlayerReady=function(api){
     ...
     //   $scope.$timeupdate3= rx.Observable.fromEvent(this.api.mediaElement, 'timeupdate').map($scope.canvasFromEven).bufferWithCount(2);
       ...
       // $scope.$timeupdate2.subscribe($scope.getectMoventInArea);
       //
