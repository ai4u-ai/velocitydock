var Rlocal = {}; // the Recurrent library
...
var zeros = Rlocal.zeros; // inherit these
var assert = Rlocal.assert;
var randi = Rlocal.randi;
var randf = Rlocal.randf;
...
DQNAgent.prototype = {
  reset: function() {
    ...
    this.net = {};
    this.net.W1 = new Rlocal.RandMat(this.nh, this.ns, 0, 0.01);
    this.net.b1 = new Rlocal.Mat(this.nh, 1, 0, 0.01);
    this.net.W2 = new Rlocal.RandMat(this.na, this.nh, 0, 0.01);
    this.net.b2 = new Rlocal.Mat(this.na, 1, 0, 0.01);
  ...
  toJSON: function() {
    ...
    j.ns = this.ns;
    j.na = this.na;
    j.net = Rlocal.netToJSON(this.net);
    return j;
  },
  fromJSON: function(j) {
    // load function
    ...
    this.ns = j.ns;
    this.na = j.na;
    this.net = Rlocal.netFromJSON(j.net);
  },
  forwardQ: function(net, s, needs_backprop) {
    var G = new Rlocal.Graph(needs_backprop);
  ...
  act: function(slist) {
    ...
    var s = new Rlocal.Mat(this.ns, 1);
    s.setFrom(slist);
    ...
    if(Math.random() < this.epsilon) {
      ...
      var a = Rlocal.maxi(amat.w); // returns index of argmax action
    }
  ...
  learnFromTuple: function(s0, a0, r0, s1, a1) {
    ...
    var qmax = r0 + this.gamma * tmat.w[Rlocal.maxi(tmat.w)];
    ...
    // update net
    Rlocal.updateNet(this.net, this.alpha);
    return tderror;
  }
}
...
SimpleReinforceAgent.prototype = {
  reset: function() {
    ...
    this.actorNet = {};
    this.actorNet.W1 = new Rlocal.RandMat(this.nh, this.ns, 0, 0.01);
    this.actorNet.b1 = new Rlocal.Mat(this.nh, 1, 0, 0.01);
    this.actorNet.W2 = new Rlocal.RandMat(this.na, this.nh, 0, 0.1);
    this.actorNet.b2 = new Rlocal.Mat(this.na, 1, 0, 0.01);
    this.actorOutputs = [];
    this.actorGraphs = [];
    ...
    this.baselineNet = {};
    this.baselineNet.W1 = new Rlocal.RandMat(this.nhb, this.ns, 0, 0.01);
    this.baselineNet.b1 = new Rlocal.Mat(this.nhb, 1, 0, 0.01);
    this.baselineNet.W2 = new Rlocal.RandMat(this.na, this.nhb, 0, 0.01);
    this.baselineNet.b2 = new Rlocal.Mat(this.na, 1, 0, 0.01);
  ...
  act: function(slist) {
    ...
    var a = Rlocal.copyMat(amat);
    var gaussVar = 0.02;
    a.w[0] = Rlocal.randn(0, gaussVar);
    a.w[1] = Rlocal.randn(0, gaussVar);
  ...
  learn: function(r1) {
    ...
    if(n >= nup) {
      ...
      Rlocal.updateNet(this.actorNet, this.alpha); // update actor network
      Rlocal.updateNet(this.baselineNet, this.beta); // update baseline network
...
RecurrentReinforceAgent.prototype = {
  reset: function() {
    ...
    this.actorLSTM = Rlocal.initLSTM(this.ns, [this.nh], this.na);
    this.actorG = new Rlocal.Graph();
    this.actorPrev = null;
    this.actorOutputs = [];
    this.rewardHistory = [];
    this.actorActions = [];

    this.baselineLSTM = Rlocal.initLSTM(this.ns, [this.nhb], 1);
    this.baselineG = new Rlocal.Graph();
  ...
  act: function(slist) {
    ...
    var actorNext = Rlocal.forwardLSTM(this.actorG, this.actorLSTM, [this.nh], s, this.actorPrev);
    this.actorPrev = actorNext;
    var amat = actorNext.o;
    this.actorOutputs.push(amat);

    // forward the baseline LSTM
    var baselineNext = Rlocal.forwardLSTM(this.baselineG, this.baselineLSTM, [this.nhb], s, this.baselinePrev);
  ...
  learn: function(r1) {
    ...
    if(n >= nup) {
      ...
      Rlocal.updateNet(this.actorLSTM, this.alpha); // update actor network
      Rlocal.updateNet(this.baselineLSTM, this.beta); // update baseline network
...
DeterministPG.prototype = {
  reset: function() {
    ...
    this.actorNet.W1 = new Rlocal.RandMat(this.nh, this.ns, 0, 0.01);
    this.actorNet.b1 = new Rlocal.Mat(this.nh, 1, 0, 0.01);
    this.actorNet.W2 = new Rlocal.RandMat(this.na, this.ns, 0, 0.1);
    this.actorNet.b2 = new Rlocal.Mat(this.na, 1, 0, 0.01);
    this.ntheta = this.na*this.ns+this.na; // number of params in actor

    // critic
    this.criticw = new Rlocal.RandMat(1, this.ntheta, 0, 0.01); // row vector
  ...
  utilJacobianAt: function(s) {
    var ujacobian = new Rlocal.Mat(this.ntheta, this.na);
    for(var a=0;a<this.na;a++) {
      Rlocal.netZeroGrads(this.actorNet);
      var ag = this.forwardActor(this.s0, true);
      ag.a.dw[a] = 1.0;
      ag.G.backward();
      var gflat = Rlocal.netFlattenGrads(this.actorNet);
  ...
  learn: function(r1) {
    ...
    //this.rewardHistory.push(r1);
    if(!(this.r0 == null)) {
      var Gtmp = new Rlocal.Graph(false);
      // dpg update:
